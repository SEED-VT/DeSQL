...
import org.apache.spark.sql.catalyst.plans.logical.{DataRegeneratorVisitorTrait, LogicalPlan, SubQueryExist, SubQueryVisitor, EnableRegeneration}
 ...
 *                                     (e.g., [[CaseWhen]]).
 */
abstract class Expression extends TreeNode[Expression] with SubQueryExist with EnableRegeneration{
