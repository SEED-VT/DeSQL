...
import org.apache.spark.sql.catalyst.plans.logical.{Aggregate, LeafNode, LogicalPlan, SubQueryExist, SubQueryVisitor, UnaryNode}
...
case class UnresolvedRelation(
    multipartIdentifier: Seq[String]) extends LeafNode with NamedRelation with SubQueryExist{
 ...
 */
case class UnresolvedAttribute(nameParts: Seq[String]) extends Attribute with Unevaluable with SubQueryExist {
...
case class UnresolvedHaving(
    ...
    child: LogicalPlan)
  extends UnaryNode with SubQueryExist{
