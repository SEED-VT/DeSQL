...
import org.apache.spark.sql.catalyst.plans.logical.{LeafNode, LogicalPlan, Statistics, SubQueryExist, SubQueryVisitor}
...
case class LogicalRelation(
  ...
  extends LeafNode with MultiInstanceRelation with SubQueryExist{
