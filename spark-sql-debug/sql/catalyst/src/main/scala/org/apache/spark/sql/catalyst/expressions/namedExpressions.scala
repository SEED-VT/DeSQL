...
import org.apache.spark.sql.catalyst.plans.logical.{EventTimeWatermark, SubQueryExist, SubQueryVisitor}
...
case class AttributeReference(
  ...
  extends Attribute with Unevaluable with SubQueryExist{
