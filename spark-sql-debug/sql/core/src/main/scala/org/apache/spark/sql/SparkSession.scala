...
import org.apache.spark.sql.catalyst.expressions.{AttributeReference, GenericRowWithSchema, UnsafeRow}
import org.apache.spark.{SPARK_VERSION, SparkConf, SparkContext, TaskContext}
import org.apache.spark.annotation.{DeveloperApi, Experimental, Stable, Unstable}
import org.apache.spark.api.java.JavaRDD
import org.apache.spark.internal.Logging
import org.apache.spark.rdd.RDD
import org.apache.spark.sql.execution.RowRecord
...
class SparkSession private(
  ...
  var debugBuffer : RDD[(GenericRowWithSchema,String,Int, String, String)] = null

  def getDebugBuffer() : RDD[(GenericRowWithSchema,String,Int, String, String)] = {
    debugBuffer
  }

  def enrollDebugBuffer(debugBufferStore: RDD[(GenericRowWithSchema,String,Int, String, String)]): Unit = {
    if(debugBuffer != null){
      debugBuffer = debugBuffer ++ debugBufferStore
    } else{
      debugBuffer = debugBufferStore
    }
  }
